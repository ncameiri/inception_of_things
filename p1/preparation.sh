...
cat >>/etc/hosts<<EOF
192.168.56.110 dmarceliS.example.com dmarceliS
192.168.56.111 dmarceliSW.example.com dmarceliSW
EOF


echo "[TASK 2] Install docker container engine"
apt update && apt-get install apt-transport-https ca-certificates curl software-properties-common -y
